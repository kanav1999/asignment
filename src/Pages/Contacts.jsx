...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-white-50   p-4  w-full ">
            <div className="m-4">
                <button className="rounded-full over bg-blue-600 hover:bg-black-700 p-6 text-3xl">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-black-500 justify-center">
